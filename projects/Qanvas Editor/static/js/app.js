...
window.onload = function() {
  ...
  // We somehow make stuff cross-platform
  var raf = (window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function(cb){window.setTimeout(cb,1000/60)});
  var craf = (window.mozCancelRequestAnimationFrame || window.webkitCancelRequestAnimationFrame || window.clearTimeout());
  ...
  var action = {
    ...
    exec : function() {
      try {
        craf(Math._id); // Cancel the requestAnimationFrame
